...
export class LoggerService implements NestLoggerService {
  ...
  constructor(@Inject(LOGGER_MODULE_OPTIONS) private loggerModuleOptions: LoggerModuleOptions, private configService: ConfigService) {
    ...
    let colorize = loggerModuleOptions.colorize === undefined ? configService.get('log.colorize') : loggerModuleOptions.colorize;
