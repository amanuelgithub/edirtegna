...
export class ModuleUtil {
  private static envFiles: string[] = FilesUtil.getEnvPath('env') as string[];
  private static currentEnv: Record<string, any>;

  static makeAsyncImportsAndProviders<T = any>(options: ModuleAsyncOptions<T>, optionsKey: string): { imports: any[]; providers: any[] } {
    const providers = [];
