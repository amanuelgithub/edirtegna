  ...
  return (
    ...
    >
      ...
      <Collapsible title="Images">
        <ThemedText>
          For static images, you can use the <ThemedText type="defaultSemiBold">@mobile2x</ThemedText> and{" "}
          <ThemedText type="defaultSemiBold">@mobile3x</ThemedText> suffixes to provide files for different screen
          densities
        </ThemedText>
      ...
      <Collapsible title="Animations">
        ...
        {Platform.select({
          ios: (
            <ThemedText>
              The <ThemedText type="defaultSemiBold">components/ParallaxScrollView.tsx</ThemedText> component provides
              a parallax effect for the header image.
            </ThemedText>
          ),
        })}
      </Collapsible>
